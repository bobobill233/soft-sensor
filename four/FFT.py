    ...
    for root, dirs, files in os.walk(input_dir):
        for file in files:
            if file.endswith(".csv"):
                ...
                if i == 642:
                    plot_separate_line_plots(downsampled_data, filename=f"line_plots_image2_{i}.png")
                i += 1
...
if __name__ == "__main__":
    # 定义输入和输出目录
    input_dir = r'D:\flow_idea2\flowdata_cleanednew'
    output_dir = r'D:\flow_idea2\flowdata_cleaned_fftnew'
